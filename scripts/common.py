...
def get_model(layer_name):
    ...
    def binary_classifier(bert_config, is_training_bert, is_training, input_ids, input_mask, segment_ids,
                     labels, num_labels, use_one_hot_embeddings):
        return multi_label_classifier(bert_config, is_training_bert, is_training, input_ids, input_mask, segment_ids,
                               labels, 1, use_one_hot_embeddings)


    def multi_class_classifier(bert_config, is_training_bert, is_training, input_ids, input_mask, segment_ids,
                          labels, num_labels, use_one_hot_embeddings):
        model = modeling.BertModel(
            config=bert_config,
            is_training=is_training_bert,
