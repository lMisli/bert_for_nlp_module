...
parser.add_argument("--label_columns", type=str, help="[Optional]label columns,the order should responding to probability_columns. Separately by ',', E.g. 'label1, label2',if None, default='[L|l]abel*'")
parser.add_argument("--probability_columns", type=str, help="[Optional]probability columns, the order should responding to label columns. Separately by ',', E.g. 'pro1, pro2',if None, default='[P|p]robability*'")
...
if __name__ == "__main__":
    # logging.info('hello')
    args.output_dir = "D:/work doc/toxic comment/output_dir/azureml/32b52175-ee08-431c-a8c6-8739fdaaa284/bilstm_output_dir/output_dir_part"
    # args.input_data = "D:/corpus/toxic comment/jigsaw-toxic-comment-classification-challenge/predict_results.csv"
    args.input_data = "D:/work doc/toxic comment/output_dir/azureml/32b52175-ee08-431c-a8c6-8739fdaaa284/bilstm_output_dir/baseline.csv"
    args.label_columns = "toxic severe_toxic obscene threat insult identity_hate"
